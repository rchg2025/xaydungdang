    ...
    <>
      ...
      <div className="admin-container">
        ...
        <footer style={{ textAlign: 'center', marginTop: '3rem', padding: '1.5rem 0', borderTop: '1px solid var(--color-border)', color: 'var(--color-text-muted)', fontSize: 'var(--text-xs)' }}>
          © {new Date().getFullYear()} Xây dựng Đảng — Đảng bộ Phường Chánh Hưng. Phát triển bởi <a href="https://rongcon.net" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--color-accent)' }}>Rồng Con HG</a>
        </footer>
      </div>
    </>
  );
